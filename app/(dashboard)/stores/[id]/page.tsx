...
import {
  ...
  ProductDetailsSwiperthumb,
  Reviwsdata,
  SwiperProducts,
} from '@/shared/data/pages/ecommerce/productdetailsdata';
...
const Productdetails: React.FC<ProductdetailsProps> = () => {
  ...
  return (
    <Fragment>
      ...
      <Row>
        <Col xxl={4}>
          <Card className="custom-card">
            <div className="sale-badge">
              Sale <span className="fs-10 op-8">30%OFF</span>{' '}
            </div>
            <Card.Body className="p-2 p-sm-5">
              {/* <SpkSwiperJs
                slides={ProductDetailsSwiper}
                spaceBetween={30}
                navigation={true}
                centeredSlides={true}
                autoplay={true}
              ...
              />
              <SpkSwiperJs
                slides={ProductDetailsSwiperthumb}
        ...
        <Col xxl={8}>
          <Card className="custom-card">
            <Card.Body>
              <div>
                <p className="fs-20 fw-semibold mb-3">
                  RoyaliX Elegance Series - Premium Stainless Steel Wrist Chain
                  Watch
                </p>
                <p className="fs-16 mb-3">
                  ...
                  <span className="fw-medium ms-1 fs-13">
                    4.7
                    <Link className="text-muted ms-2" href="#!">
                      (2.5k Reviews)
                    </Link>
                  </span>
                </p>
                <Row className="gy-3 gy-xl-0">
                  <Col xl={7}>
                    <Link
                      ...
                      className="btn btn-outline-primary btn-w-lg me-2 mb-3"
                    >
                      <i className="ri-heart-line fs-16 align-middle lh-1"></i>{' '}
                      Add to Wishlist
                    </Link>
                    <div className="mb-1">
                    ...
                    <div className="mb-3">
                      ...
                      <p className="text-muted mb-0 fs-13">
                        Experience the luxury of the RoyalX Elegance Series
                        wristwatch, crafted with a premium stainless steel
                        chain, sapphire glass, and water-resistant technology.
                        Perfect for formal and casual occasions.
                      </p>
                    </div>
                    <div className="d-flex gap-2 align-items-center mb-3">
                      <p className="mb-1 text-success py-1 px-2 bg-success-transparent rounded-pill fs-12">
                        <i className="ri-checkbox-circle-fill me-1 align-middle d-inline-block"></i>{' '}
                        Instock
                      </p>
                      <p className="mb-1 text-success py-1 px-2 bg-success-transparent rounded-pill fs-12">
                        <i className="ri-checkbox-circle-fill me-1 align-middle d-inline-block"></i>{' '}
                        ...
                        <div className="product-quantity-container ecommerce-page-quantity">
                          <div className="input-group flex-nowrap rounded-pill cart-input-group">
                            <SpkButton
                              ...
                              onClickfunc={dec}
                              Customclass="btn-icon btn-wave btn-sm product-quantity-minus waves-effect waves-light"
                              Buttontype="button"
                            >
                    ...
                    <div className="d-flex gap-3 align-items-center flex-shrink-0 flex-wrap mb-4">
                      ...
                      <p className="mb-0 d-flex align-items-center flex-wrap">
                        <Link
                          className="color-1 product-colors flex-shrink-0 selected"
                          href="#!"
                          scroll={false}
                        >
                        ...
                        <Link
                          className="color-2 product-colors flex-shrink-0"
                          href="#!"
                          scroll={false}
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        ...
                        <Link
                          className="color-3 product-colors flex-shrink-0"
                          href="#!"
                          scroll={false}
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        ...
                        <Link
                          className="color-4 product-colors flex-shrink-0"
                          href="#!"
                          scroll={false}
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                        ...
                        <Link
                          className="color-5 product-colors flex-shrink-0"
                          href="#!"
                          scroll={false}
                        >
                          <i className="ri-checkbox-blank-circle-fill"></i>
                    ...
                    <div className="d-flex gap-2 align-items-center flex-wrap">
                      ...
                      >
                        <i className="bx bx-credit-card fs-16 align-middle"></i>{' '}
                        Buy Now
                      </Link>
                      <Link
                        href="/pages/ecommerce/cart"
                        className="btn btn-success btn-w-lg"
                      >
                        <i className="bx bx-cart-add fs-16 align-middle"></i>{' '}
                        Add to Cart
                      </Link>
                    </div>
                  </Col>
                    ...
                    <div className="p-xl-3 text-center">
                      <div className="list-group list-group-flush p-2 bg-light rounded mb-3">
                        ...
                        <div className="list-group-item d-flex align-items-center justify-content-between">
                          ...
                          <div className="lh-1 fs-14 text-success">
                            <i className="ri-secure-payment-line"></i>
                          </div>
                        </div>
                        <div className="list-group-item d-flex align-items-center justify-content-between">
                          <div className="text-muted">
                            5-star rated product in good condition
                          </div>
                      ...
                      <div className="d-flex gap-1 justify-content-between flex-wrap mb-3 align-items-center p-2 bg-light rounded">
                        ...
                        <span className="badge bg-pink fs-11 ms-3">
                      ...
                      <div className="p-3 border border-dashed rounded">
                        <h3 className="mb-1">
                          ...
                          <span className="fs-13 text-danger">
                            {' '}
                            Special off on cauals
                          </span>
                        </h3>
                        <div className="text-muted fs-12 mb-3">
                          check below some of the offers on{' '}
                        </div>
                        ...
                        <Link
                          href="#!"
                          className="btn btn-secondary-light d-grid"
                        >
        ...
        <Col xxl={3}>
          <Card className="custom-card overflow-hidden">
            <Card.Header className="justify-content-between">
              ...
              <Link href="#!" className="btn btn-sm btn-primary-light">
                View All
              </Link>
            </Card.Header>
                      ...
                      <td>
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            <p className="mb-0 fs-14 fw-semibold similar-product-name text-truncate">
                              {product.name}
                            </p>
                            <div className="mb-2">
          ...
          <Tab.Container defaultActiveKey="product">
            <Card className="custom-card">
              <Card.Header className="border-bottom-0">
                <Nav
                  className="nav nav-tabs tab-style-8 scaleX profile-settings-tab gap-2"
                  id="myTab4"
                  role="tablist"
                >
                  <Nav.Item className="" role="presentation">
                    <Nav.Link
                      eventKey="product"
                      className="bg-primary-transparent px-4"
                      id="product-details"
                      data-bs-toggle="tab"
                  ...
                  <Nav.Item className="" role="presentation">
                    <Nav.Link
                      ...
                      id="key-features-tab"
                      data-bs-toggle="tab"
                      data-bs-target="#key-features-tab-pane"
                      type="button"
                      role="tab"
                      aria-controls="key-features-tab-pane"
                      aria-selected="false"
                      tabIndex={-1}
                    >
                      Key Features
              ...
              <Tab.Content className="card-body">
                <Tab.Pane
                  eventKey="product"
                  className="overflow-hidden p-0 border-0 rounded-0"
                ...
                <Tab.Pane
                  ...
                  id="key-features-tab-pane"
                  role="tabpanel"
                  aria-labelledby="key-features-tab"
                  tabIndex={1}
                >
                  <ul className="mb-0 ps-0 list-unstyled">
                    {Featuresdata.map((feature, index) => (
                      <li
                        key={index}
                        className={`mb-${index === Featuresdata.length - 1 ? '0' : '3'}`}
                      >
                        <span className="fw-semibold">{feature.label}:</span>{' '}
                        {feature.description}
                      </li>
                    ))}
                  </ul>
          ...
          <Card className="custom-card">
            <div className="p-3">
              ...
              {/* <SpkSwiperJs
                ...
                centeredSlides={true}
                autoplay={true}
                className="mySwiper swiper-reviews"
              /> */}
            </div>
          </Card>
        </Col>
              ...
              <div className="list-group list-group-flush bg-light rounded">
                <div className="list-group-item">
                  <div className="text-muted">
                    ...
                    Rated for water resistance up to 50 meters, making it
                    suitable for swimming and light diving.
                  </div>
                </div>
                <div className="list-group-item">
                  <div className="text-muted">
                    ...
                    Equipped with a durable, scratch-resistant sapphire crystal
                    to maintain its clear and polished appearance.
                  </div>
                </div>
                <div className="list-group-item">
                  <div className="text-muted">
                    ...
                    The stainless steel wrist chain features an adjustable clasp
      ...
      <p className="">
        Discover more products similar to this one and elevate your style.
      </p>
      {/* <SpkSwiperJs
        slides={SwiperProducts}
        ...
        autoplay={true}
        loop={true}
        className="mySwiper swiper-related-products"
      /> */}
      {/* <!-- End:: Row-2 --> */}
    </Fragment>
  );
