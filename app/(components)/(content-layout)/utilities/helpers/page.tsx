...
const Helpers: React.FC<HelpersProps> = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            {/* <!-- Start:: row-1 --> */}
            <Row>
                <Col xxl={4} lg={6} md={6} sm={12} className="">
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <div className="card text-bg-success mb-3 text-fixed-white" style={{ maxWidth: "31rem" }}>
                            ...
                            <div className="card text-bg-danger mb-3 text-fixed-white" style={{ maxWidth: "31rem" }}>
                                <div className="card-header border-bottom-0">
                                    <div className="card-title text-fixed-white">
                                        Header
                                    </div>
                ...
                <Col xxl={3} lg={6} md={6} sm={12} className="">
                    <Card className="custom-card streched-card">
                        ...
                        <Card.Body>
                            <Image fill className="bd-placeholder-img card-img-top card-img" src="../../assets/images/media/media-4.jpg" alt="..." />
                ...
                <Col xxl={5} lg={12} sm={12} className="">
                    <Card className="custom-card">
                        <Card.Header>
                            <div className="card-title">
