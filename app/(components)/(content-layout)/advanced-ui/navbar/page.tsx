					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar defaultValue="" expand="lg" className="navbar navbar-expand-lg bg-light">
								<Container fluid>
									<Navbar.Brand>
										<Image fill src="../../assets/images/brand-logos/toggle-logo.png" alt="" className="d-inline-block align-text-top" />
									</Navbar.Brand>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar className="navbar bg-light mb-3">
								<Container fluid>
									<Link className="navbar-brand" href="#!" scroll={false}><Image fill src="../../assets/images/brand-logos/toggle-logo.png" alt="" /></Link>
								</Container>
							</Navbar>
							<Navbar className="navbar bg-light">
								<Container fluid>
									<span className="navbar-brand mb-0 h1"><Image fill src="../../assets/images/brand-logos/toggle-logo.png" alt="" /></span>
								</Container>
							</Navbar>
						</Card.Body>
					</Card>
				...
				<Col xl={12}>
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar className="navbar bg-light mb-3">
								<Container fluid>
									<Navbar.Brand href="#!">  <Image fill src="../../assets/images/brand-logos/toggle-logo.png" alt="" /></Navbar.Brand>
									<Form className="d-flex" role="search">
							...
							<Navbar className="navbar bg-light">
								<Container fluid>
									<Navbar.Brand className="navbar-brand" href="#!">
										<Image src="../../assets/images/brand-logos/toggle-logo.png" alt="" width={32}
											height={30} className="d-inline-block align-text-top" /> Bootstrap
									</Navbar.Brand>
								</Container>
							</Navbar>
						</Card.Body>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-primary mb-3">
								<Container fluid>
									<Navbar.Brand href="#!">
										<Image fill src="../../assets/images/brand-logos/toggle-white.png" alt="" />
									</Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary mb-3">
								<Container fluid>
									<Navbar.Brand href='#!'>  <Image fill src="../../assets/images/brand-logos/toggle-white.png" alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary-transparent mb-3">
								<Container fluid>
									<Navbar.Brand href="#!" className="navbar-brand">  <Image fill src="../../assets/images/brand-logos/toggle-logo.png" alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar className="navbar navbar-dark bg-dark rounded-0 custom-navbar-dark">
								<Container fluid>
									<SpkButton Buttonvariant='' onClickfunc={() => setOpen(!open)} Customclass="nav-toggle navbar-dark-btn-toggler" Buttoncontrols="example-collapse-text" Expand={open}>
