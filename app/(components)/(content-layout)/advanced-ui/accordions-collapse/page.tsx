            ...
            <div className="row">
                <Col xl={6}>
                    <ShowCode title="Primary" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion10} reusableCode={reusableaccordion10}>
                        <SpkAccordions items={Basicdata} accordionClass="accordion-border-primary accordions-items-separate" defaultActiveKey={1} />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Success" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion11} reusableCode={reusableaccordion11}>
                        <SpkAccordions items={Basicdata} accordionClass="accordion-border-success accordions-items-separate" defaultActiveKey={1} />
                    </ShowCode>
                </Col>
            </div>
            {/* <!-- End:: row-4 --> */}
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Custom Icon Accordion" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion8} reusableCode={reusableaccordion8}>
                        <SpkAccordions items={Basicdata} accordionClass="accordion-customicon1 accordions-items-separate" defaultActiveKey={1} />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Custom Accordion" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion9} reusableCode={reusableaccordion9}>
                        <SpkAccordions items={Customdata} accordionClass="customized-accordion accordions-items-separate" defaultActiveKey={1} />
                    </ShowCode>
                </Col>
            </Row>
            {/* <!-- End:: row-6 --> */}
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Without Icon" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion13} reusableCode={reusableaccordion13}>
                        <SpkAccordions items={Basicdata} accordionClass="accordionicon-none accordions-items-separate" defaultActiveKey={1} />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Left Aligned Icons" customCardClass="custom-card" customCardBodyClass="" reactCode={accordion12} reusableCode={reusableaccordion12}>
                        <SpkAccordions items={Basicdata} accordionClass="accordionicon-left accordions-items-separate" defaultActiveKey={1} />
                    </ShowCode>
                </Col>
            </Row>
            {/* <!-- End:: row-9 --> */}
