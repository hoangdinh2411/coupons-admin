			...
			<Row>
				...
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Paginationdata} spaceBetween={30} centeredSlides={true} pagination={{ dynamicBullets: true, clickable: true }} autoplay={true} className="mySwiper" />
						</Card.Body>
					</Card>
				</Col>
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Dynamicdata} spaceBetween={30} centeredSlides={true} pagination={{ dynamicBullets: true, clickable: true }} autoplay={true} className="mySwiper" />
						</Card.Body>
					</Card>
				</Col>
				<Col xl={4} lg={6} md={6} sm={12} className="">
				...
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Keyboarddata} pagination={{ dynamicBullets: true, clickable: true }} autoplay={true} slidesPerView={1} spaceBetween={30} navigation={true} keyboard={{ enabled: true }} className="mySwiper" />
						</Card.Body>
					</Card>
				</Col>
				<Col xl={4} lg={6} md={6} sm={12} className="">
				...
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Effectcubedata} spaceBetween={30} cubeEffect={{ shadow: true, slideShadows: true, shadowOffset: 20, shadowScale: 0.94 }} effect={"cube"} navigation={true} pagination={{ dynamicBullets: true, clickable: true }} autoplay={true} className="mySwiper swiper swiper-fade cube-custom" />
						</Card.Body>
					</Card>
				</Col>
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Effectfadedata} effect={"fade"} pagination={{ dynamicBullets: true, clickable: true }} navigation={true} autoplay={true} className="mySwiper swiper-fade" />
						</Card.Body>
					</Card>
				</Col>
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Effectflipdata} effect={"flip"} grabCursor={true} pagination={{ dynamicBullets: true, clickable: true }} navigation={true} autoplay={true} className="mySwiper" />
						</Card.Body>
					</Card>
				</Col>
			</Row>
			...
			<Row>
				<div className="col-xl-12">
					<Card className="custom-card">
						...
						<Card.Body>
							<SpkSwiperJs slides={Effectcovberflowdata} effect={"coverflow"} grabCursor={true} centeredSlides={false} slidesPerView={4} pagination={{ dynamicBullets: true, clickable: true }} autoplay={true} coverflowEffect={{ rotate: 50, stretch: 0, depth: 100, modifier: 1, slideShadows: true }} className="mySwiper" />
						</Card.Body>
					</Card>
				</div>
			</Row>
