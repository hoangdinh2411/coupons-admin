...
const RangeSliders: React.FC<RangeSlidersProps> = ({ local_varaiable }: any) => {
    ...
    return (
        <Fragment>
            {/* <!-- Page Header --> */}
            <Seo title="Forms-Range Slider" />

            <Pageheader title="Forms" currentpage="Range Slider" activepage="Range Slider" />
