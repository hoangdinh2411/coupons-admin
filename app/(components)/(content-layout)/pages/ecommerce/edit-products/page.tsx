...
const Editproducts: React.FC<EditproductsProps> = () => {
  ...
  return (
    <Fragment>
      ...
      {/* <!-- Page Header --> */}
      <Seo title="Pages-Edit Products" />

      <Pageheader title="Pages" currentpage="Edit Products" activepage="Edit Products" />
                    ...
                    <Card.Body className="p-0">
                      <div className="row gy-3">
                        ...
                        <Col xl={12}>
                          ...
                          <Form.Control type="text" className="" id="product-name-add" defaultValue={"Light Blue Sweat Shirt"} />
                        ...
                        <Col xl={6}>
                          ...
                          <SpkSelect name="colors" option={Sizeselect} mainClass="basic-multi-select"
                            menuplacement='auto' classNameprefix="Select2" placeholder="Select" defaultvalue={Sizeselect[3]}
                          />
                        </Col>
                        <Col xl={6}>
                          ...
                          <SpkSelect name="colors" option={Brandselect} mainClass="basic-multi-select"
                            menuplacement='auto' classNameprefix="Select2" placeholder="Select" defaultvalue={Brandselect[5]}
                          />
                        </Col>
                        <Col xl={4}>
                          ...
                          <SpkSelect name="colors" option={Categoryselect} mainClass="basic-multi-select"
                            menuplacement='auto' classNameprefix="Select2" placeholder="Category" defaultvalue={Categoryselect[3]}
                          />
                        </Col>
                        <Col xl={4}>
                          ...
                          <SpkSelect name="colors" option={Genderselect} mainClass="basic-multi-select"
                            menuplacement='auto' classNameprefix="Select2" placeholder="Select" defaultvalue={Genderselect[1]}
                          />
                        </Col>
                        <div className="col-xl-4 color-selection">
                          ...
                          <SpkSelect multi name="colors" option={Colorselect} mainClass="basic-multi-select"
                            menuplacement='auto' classNameprefix="Select2" placeholder="Select" defaultvalue={Colorselect[6]}
                          />
                        </div>
                        <Col xl={12}>
                        ...
                        <Col xl={6}>
                          ...
                          <Form.Control type="text" className="" id="product-cost-add" placeholder="Cost" defaultValue={"$1,299.99"} />
                        ...
                        <Col xl={6}>
                          ...
                          <Form.Control type="text" className="" id="product-discount1" placeholder="Weight in gms" defaultValue={"180gms"} />
                        </Col>
                        <Col xl={6}>
                          <Form.Label htmlFor="product-status-add1" className="">Availability</Form.Label>
                          <SpkSelect name="colors" option={Availableselect} mainClass="basic-multi-select" menuplacement='auto' classNameprefix="Select2" placeholder="Select" defaultvalue={Availableselect[1]} />
                        </Col>
                        <Col xl={12}>
                        ...
                        <Col xl={6} className="custom-picker">
                          ...
                          <SpkDatepickr className="form-control" selected={dates["limitPicker"] ? new Date(dates["limitPicker"]) : null} onChange={(date: Date | null) => handleDateChange("limitPicker", date)} showTimeSelect showTimeSelectOnly timeIntervals={15} Caption="Time" dateFormat="h:mm aa" />
                        </Col>
                        <Col xl={12}>
                          ...
                          <SpkSelect name="colors" option={Publishselect} mainClass="basic-multi-select"
                            menuplacement='auto' classNameprefix="Select2" placeholder="Select" defaultvalue={Publishselect[2]}
                          />
                        </Col>
                        <Col xl={12}>
