...
const NavsTabs: React.FC<NavsTabsProps> = () => {
    return (
        <Fragment>
            ...
            {/* <!-- Page Header --> */}
            <Seo title="Ui Elements-Navs & Tabs" />
                                        ...
                                        <div className="table-responsive">
                                            <SpkTables tableClass="mb-0" header={[{ title: 'Product' }, { title: 'Name' }, { title: 'Category' }, { title: 'Price' }]} >
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <Image height={28} width={28} src="../../assets/images/ecommerce/png/32.png" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Alarm Clock</td>
                                                    <td>Clocks</td>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <Image height={28} width={28} src="../../assets/images/ecommerce/png/23.png" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Wrist Watch</td>
                                                    <td>Gadgets</td>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <Image height={28} width={28} src="../../assets/images/ecommerce/png/15.png" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Sport Shoes</td>
                                                    <td>Footwear</td>
                                                ...
                                                <div className="d-sm-flex">
                                                    <div className="me-3">
                                                        <span className="avatar avatar-xxl">
                                                            <Image width={80} height={80} src="../../assets/images/faces/9.jpg" alt="img" />
                                                        </span>
                                                    </div>
                                                    <div>
                            ...
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 border-0" role="tablist">
                                    ...
                                    <SpkDropdown Customclass="nav-item" Customtoggleclass="nav-link" Togglevariant="" Toggletext="Company" Navigate="#!">
                                        <Link className="dropdown-item" scroll={false} href="#!">About</Link>
                                        <Link className="dropdown-item" scroll={false} href="#!">Another action</Link>
                                        <Link className="dropdown-item" scroll={false} href="#!">Something else here
                                        </Link>
                                        <hr className="dropdown-divider" />
                                        <Link className="dropdown-item" href="#!" scroll={false}>Separated link</Link>
                                    </SpkDropdown>
                                    <Nav.Item>
    ...
    <Card.Body className="">
        <Nav className=" nav-pills mb-3" role="tablist">
            <Nav.Item>
                <Nav.Link eventKey="pillproduct" data-bs-toggle="tab" role="tab" aria-current="page" aria-selected="true">
                    Products
                </Nav.Link>
            </Nav.Item>
            <Nav.Item>
                <Nav.Link eventKey="dropdown">
                    <SpkDropdown Customclass="" Customtoggleclass="p-0" toggleas="button" Toggletext="Cart" Navigate="#!">
                        <button className="dropdown-item" type="button" onClick={() => console.log('Navigate to Wishlist')}>
                            Wishlist
                        </button>
                        <button className="dropdown-item" type="button" onClick={() => console.log('Navigate to Liked')}>
                            Liked
                        </button>
                        <button className="dropdown-item" type="button" onClick={() => console.log('Navigate to Save For Later')}>
                            Save For Later
                        </button>
                        <hr className="dropdown-divider" />
                        <button className="dropdown-item" type="button" onClick={() => console.log('Navigate to Recently Viewed')}>
                            Recently Viewed
                        </button>
                    </SpkDropdown>
                </Nav.Link>
            ...
            <Nav.Item>
                <Nav.Link eventKey="pillorders" data-bs-toggle="tab" role="tab" aria-current="page" aria-selected="false">
                    Orders
                </Nav.Link>
            </Nav.Item>
            <Nav.Item>
        ...
        <Tab.Content>
            <Tab.Pane eventKey="pillproduct" className="text-muted" id="pill-products" role="tabpanel">
                How travel coupons make you a better lover. Why cultural solutions are the new black. Why mom was right about travel insurances. How family trip ideas can help you predict the future. <b>How carnival cruises make you a better lover</b>. Why you'll never succeed at daily deals.
            </Tab.Pane>
            <Tab.Pane eventKey="pillwishlist" className="text-muted" id="pill-wishlist" role="tabpanel">
                How hotel deals can help you live a better life. <b>How celebrity cruises</b> aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it.
            </Tab.Pane>
            <Tab.Pane eventKey="pillorders" className="text-muted" id="pill-orders" role="tabpanel">
                Unbelievable healthy snack success stories. 12 facts about safe food handling tips that will impress your friends. Restaurant weeks by the numbers. Will mexican food ever rule the world? The 10 best thai restaurant youtube videos. How restaurant weeks can make you sick.
            </Tab.Pane>
        </Tab.Content>
    </Card.Body>
</Tab.Container>
