    ...
    return (
        <Fragment>
            ...
            <div className="row">
                <Col xxl={3} xl={6} md={6} sm={12} className="">
                    <SpkCard titleClass="fw-medium" imgClass="card-img-top" footer="<span class='card-text'>Last updated 3 mins ago</span>"
                        imgSrc="../../assets/images/media/media-18.jpg" title="Card title" bodyText={(
                            <>
                ...
                <Col xxl={3} xl={6} md={6} sm={12} className="">
                    <SpkCard titleClass="fw-medium px-3 pt-3" bodyClass="p-0" imgClass="card-img-top" imgSrc="../../assets/images/media/media-20.jpg" title="Card title" bodyText={(
                        <>
                ...
                <Col xxl={3} xl={6} md={6} sm={12} className="">
                    <SpkCard imgClass="card-img-top" imgSrc="../../assets/images/media/media-19.jpg" bodyText={(
                        <>
                    ...
                    <SpkCard bodyText={(
                        <>
                            ...
                            <p className="">It is a long established fact that a reader will be distracted by the readable content.</p>
                            <Link scroll={false} href="#!" className="btn btn-secondary me-2">Read More</Link>
                            <Link scroll={false} href="#!" className="btn btn-primary">Get Details</Link>
                        </>
                    )}
                    />
                </Col>
            ...
            <div className="row">
                ...
                <Col xl={2}>
                    <SpkCard  cardClass="mountains-card" bodyText={(
                        <> 
                ...
                <Col xl={2}>
                    <SpkCard  cardClass="mountains-card" bodyText={(
                        <>
                         <Image fill src="../../assets/images/media/media-7.jpg"  className="card-img mb-3" alt="..." />
                    ...
                    <SpkCard  cardClass="mountains-card" bodyText={(
                        <>
                         <Image fill src="../../assets/images/media/media-9.jpg" className="card-img mb-3" alt="..." />
                            <h6 className="card-title fw-medium mb-3">Nature<SpkBadge variant="pink" Customclass="float-end fs-10">offer</SpkBadge></h6>
                            <p className="card-text">With supporting text below as a natural lead-in.</p>
                        </>
                    )}
                    />
                    ...
                    <div className="row row-cols-12">
                        <div className="col grid-cards">
                            <SpkCard
                                bodyText={(
                                    <>
                                     <Image fill src="../../assets/images/media/media-22.jpg" className="card-img mb-3" alt="..." />
            ...
            <div className="row">
                ...
                <div className="col-xl-4">
                    <Spkimageoverlaycard CustomClass="overlay-card" Title=" Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" Imgsrc="../../assets/images/media/media-34.jpg" Custombodyclass="text-fixed-white" Customfooterclass="text-fixed-white" CardHeader={true} CardFooter={true} Footertext="Last updated 3 mins ago" >
            ...
            <div className="row">
                <div className="col-xl-3">
                    <Spkbgcards Navigate="#!" color="primary" Imgsrc="../../assets/images/faces/11.jpg" Title="Adam Smith" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
                </div>
                <div className="col-xl-3">
                ...
                <div className="col-xl-3">
                    <Spkbgcards Navigate="#!" color="info" Imgsrc="../../assets/images/faces/8.jpg" Title="Monica Karen" Value="Pending from 4 days" Textclass="fixed-white" Class="fixed-white" />
                </div>
                <div className="col-xl-3">
                ...
                <div className="col-xl-3">
                    <Spkbgcards Navigate="#!" color="light" Imgsrc="../../assets/images/faces/13.jpg" Title="Jacob Smith" Value="Finished by 24,Nov" Textclass="muted" Class="text-default" />
                </div>
                <div className="col-xl-3">
                    <Spkbgcards Navigate="#!" color="dark" Imgsrc="../../assets/images/faces/16.jpg" Title="Pope Adam" Value="Completed on 24,may" Textclass="text-white" Class="fixed-white" />
                </div>
            </div>
            {/* <!-- End::row-9 --> */}
            ...
            <div className="row">
                <div className="col-xxl-3 col-xl-12">
                    <SpkCard imgSrcA="../../assets/images/media/media-19.jpg" imgClassA="card-img-top" linkTag={true} titleClass="fw-medium mb-0" title="Forests are Awesome." />
                </div>
