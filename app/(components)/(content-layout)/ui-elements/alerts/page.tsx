            ...
            <Row>
                ...
                <Col xl={6}>
                    <ShowCode title="Alerts with icons" customCardClass="custom-card" reactCode={reactalert14} reusableCode={reusealert14}>
                        <SpkAlerts variant="primary" CustomClass="d-flex align-items-center">
                        ...
                        <SpkAlerts variant="success" CustomClass="d-flex align-items-center">
                        ...
                        <SpkAlerts variant="warning" CustomClass="d-flex align-items-center">
                        ...
                        <SpkAlerts variant='danger' CustomClass=" d-flex align-items-center">
                    ...
                    <Row>
                        ...
                        <Col xxl={3} xl={6} lg={6} md={6} sm={6} className="col-12">
                            <Card className=" bg-white border-0">
                                <SpkAlerts variant="success" CustomClass="custom-alert1" show={alert['secondary']}>
                                    ...
                                    <div className="text-center px-5 pb-0 svg-success">
                                        <svg className="custom-alert-icon svg-success" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000">
                                        ...
                                        <div className="">
                                            <SpkButton Buttonvariant="success" Buttontype="button" Customclass="m-1" Size="sm">Close</SpkButton>
                                        </div>
                                    </div>
                                </SpkAlerts>
                            </Card>
