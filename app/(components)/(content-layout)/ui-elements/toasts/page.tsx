            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic example" customCardClass="custom-card" customCardBodyClass="" reactCode={toast1} reusableCode={reusabletoast1}>
                        <SpkToast show={toasts['basic']} onClose={() => handleToasts('basic')} title="Rixzo" message="Hello, world! This is a toast message." timestamp="11 min ago" imgSrc="../../assets/images/brand-logos/toggle-logo.png" ToastHeader={true} toastClass="custom-toast" headerClass="text-default" imgClass="custom-img-class" autohide={false} />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Live example" customCardClass="custom-card" customCardBodyClass="" reactCode={toast2} reusableCode={reusabletoast2}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast show={toasts['live'] || false} onClose={() => handleToasts('live')} title="Rixzo" message="Hello, world! This is a toast message." timestamp="11 min ago" imgSrc="../../assets/images/brand-logos/toggle-logo.png" ToastHeader={true} toastClass="custom-toast" headerClass="text-default" imgClass="custom-img-class" autohide={false} />
                        </ToastContainer>
                    </ShowCode>
                ...
                <Col xl={6}>
                    <ShowCode title="Stacking" customCardClass="custom-card" customCardBodyClass="" reactCode={toast3} reusableCode={reusabletoast3}>
                        <ToastContainer className="toast-container position-static">
                            ...
                            <SpkToast show={toasts["stack"]} onClose={() => handleToasts('stack')} ToastHeader={true} toastClass="fade show" headerClass="text-default" imgSrc="../../assets/images/brand-logos/toggle-logo.png" imgClass="me-2" title="Rixzo" timestamp="just now" message={"See? Just like this."} />
                            <SpkToast show={toasts["stack1"]} onClose={() => handleToasts('stack1')} ToastHeader={true} toastClass="fade show" headerClass="text-default" imgSrc="../../assets/images/brand-logos/toggle-logo.png" imgClass="me-2" title="Rixzo" timestamp="2 seconds ago" message={" Heads up, toasts will stack automatically"} />
                ...
                <Col xl={6}>
                    <ShowCode title=" Color schemes" customCardClass="custom-card" customCardBodyClass="" reactCode={toast4} reusableCode={reusabletoast4}>
                        ...
                        <SpkToast toastClass="align-items-center text-bg-secondary border-0 fade show mb-4" message="Hello, world! This is Secondary toast. " btnClass="btn-close btn-close-white me-2 m-auto" show={toasts["secondary"]} onClose={() => handleToasts('secondary')} ToastBtn={true} ToastHeader={false} />
                        <SpkToast toastClass="align-items-center text-bg-success border-0 fade show mb-4" message="Hello, world! This is Success toast message. " btnClass="btn-close btn-close-white me-2 m-auto" show={toasts["warning"]} onClose={() => handleToasts('warning')} ToastBtn={true} ToastHeader={false} />
            ...
            <Row>
                ...
                <Col xl={12}>
                    <ShowCode title="Translucent" customCardClass="custom-card" customCardBodyClass="" reactCode={toast7} reusableCode={reusabletoast7}>
                        <SpkToast ToastHeader={true} onClose={() => handleToasts('transColor')} show={toasts['transColor']} toastClass="show" headerClass="text-default" imgClass="me-2" imgSrc="../../assets/images/brand-logos/toggle-logo.png" title="Rixzo" timestamp="11 mins ago" message="Hello, world! This is a toast message." />
                    </ShowCode>
                    ...
                    <ShowCode title="Aligning Toast Using Flexbox" customCardClass="custom-card" customCardBodyClass="" reactCode={toast9} reusableCode={reusabletoast9}>
                        <div className="bd-example bg-light bd-example-toasts d-flex p-0 px-3">
                            <div aria-live="polite" aria-atomic="true"
                                ...
                                <SpkToast ToastHeader={true} show={toasts['alignColor']} onClose={() => handleToasts('alignColor')} toastClass="fade show shadow-lg" headerClass="text-default" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-logo.png" title="Rixzo" timestamp="11 mins ago" message="Hello, world! This is a toast message." />
                            </div>
                        </div>
                    </ShowCode>
                </Col>
                    ...
                    <ShowCode title="Toast Placements" customCardClass="custom-card" customCardBodyClass="" reactCode={toast10} reusableCode={reusabletoast10}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 start-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('topLeft')} show={toasts['topLeft'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-0 start-50 translate-middle-x p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('topCenter')} show={toasts['topCenter'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('topRight')} show={toasts['topRight'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 start-0 translate-middle-y p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('middleLeft')} show={toasts['middleLeft'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 start-50 translate-middle">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('middleCenter')} show={toasts['middleCenter'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 end-0 translate-middle-y p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('middleRight')} show={toasts['middleRight'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 start-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('bottomLeft')} show={toasts['bottomLeft'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 start-50 translate-middle-x p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('bottomCenter')} show={toasts['bottomCenter'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('bottomRight')} show={toasts['bottomRight'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Rixzo" message="Your,toast message here." />
                        </ToastContainer>
                    </ShowCode>
                </Col>
            </Row>
