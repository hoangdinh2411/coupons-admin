...
const PieChart: React.FC<PieChartProps> = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Pageheader title="Apex Charts" currentpage="Apex Pie Charts" activepage="Apex Pie Charts" />
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="pie-monochrome">
                                <Spkapexcharts chartOptions={Piemonooptions} chartSeries={Piemonoseries} type="pie" width={"100%"} height={337} />
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
