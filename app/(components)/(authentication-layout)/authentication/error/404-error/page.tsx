                        ...
                        <div className="my-auto">
                            <Row className="align-items-center justify-content-center h-100">
                                <Col xl={10} lg={5} md={6} className="col-12 text-fixed-white">
                                    <div>
                                        <p className="error-text">4<span className="text-secondary">0</span>4</p>
                                        <p className="fs-20 fw-semibold mb-0 op-9">Page Not Found...</p>
                                        <p className="fs-14 mb-5 text-fixed-white op-7 fw-normal">Sorry, the page you're looking for doesn't exist. It may have been moved, deleted, or the URL could be incorrect.</p>
