...
export const Featuresdata: Feature[] = [
  {
    label: 'Design',
    description:
      'Sleek and sophisticated design crafted from premium stainless steel for a luxurious and durable finish.',
  },
  {
    label: 'Water Resistance',
    description:
      'Up to 50 meters of water resistance, making it perfect for daily wear and light water activities.',
  },
  {
    label: 'Movement',
  ...
  },
  {
    label: 'Strap',
    description:
      'Stainless steel wrist chain with a secure clasp for a comfortable yet elegant fit.',
  },
  {
    label: 'Warranty',
    description:
      'Backed by a 2-year international warranty, offering peace of mind for your purchase.',
  },
  {
    label: 'Dial',
  ...
  },
  {
    ...
    description:
      'Features glow-in-the-dark hands for easy readability, even in low-light conditions.',
  },
  {
    label: 'Style',
    description:
      'Perfectly suited for both formal occasions and everyday wear, elevating your fashion game effortlessly.',
  },
];
...
export const reviews: Review[] = [
  {
    ...
    description:
      "The RoyaliX Elegance Series watch is a perfect blend of style and durability. The stainless steel design is stunning, and it's comfortable for daily wear. The water resistance is a great!",
  ...
  },
  {
    ...
    description:
      'I absolutely love my RoyaliX Elegance Series watch. The stainless steel wrist chain is both elegant and comfortable, and it fits perfectly. The luminous hands make it easy to read!',
  ...
  <div className="swiper-slide" key={index}>
    <div className="d-sm-flex d-block align-items-start">
      ...
      <div className="ms-auto mt-sm-0 mt-2 text-end">
        ...
        <SpkButton Buttonvariant="light" Customclass="btn-sm me-2" Buttontype="button">
          {' '}
          Report{' '}
        </SpkButton>
        <SpkButton
          Buttonvariant="primary-light"
          Customclass="btn-sm btn-icon me-2"
          Buttontype="button"
        >
