		...
		<Fragment>
			...
			<div className="row">
				...
				<Col xl={6} ref={rightContainerRef} id="draggable-right">
					...
					<Spkbgcards Navigate="#!" color="secondary" Imgsrc="../../assets/images/faces/5.jpg" Title="Sonia Agarwal" Value="In leave for 1 month" Textclass="fixed-white" Class=' drag-card' />
					...
					<Modal show={fullscreenshow} fullscreen={fullScreen} onHide={() => setfullscreenShow(false)}>
						<Modal.Header>
							<Modal.Title as="h5">Fullscreen Button</Modal.Title>
