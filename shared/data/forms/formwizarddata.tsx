        ...
        description: (
            <div className="wizard-step wizard-tab">
                <div className="wizard-content container">
                    ...
                    {/* Using useEffect to toggle the 'd-none' dynamically */}
                    <Col xl={7}>
                        <div className="login-page">
                            ...
                            <div className="row justify-content-center gy-4">
                                <Col xl={12}>
                                    ...
                                    <Form.Control type="text" className="form-control" id="email-address" placeholder="Enter Email Address" />
                                </Col>
                                <Col xl={12}>
                                    <Form.Label htmlFor="password" className="form-label">Enter Password</Form.Label>
                                    <Form.Control type="password" className="form-control" id="password" placeholder="Enter Password" />
                                </Col>
                                <Col xl={12}>
                                    <div className="d-grid">
                                        <Link scroll={false} href="#!" className="btn btn-primary px-4">Login</Link>
                                    </div>
                                </Col>
                            </div>
                        </div>
                ...
                <Row className='wizard-content container'>
                    <Col xl={12}>
                        <div className="checkout-payment-success">
                            ...
                            <div className="mb-4">
                                <Image fill src="../../assets/images/ecommerce/png/27.png" alt="" className="img-fluid" />
                            </div>
                            <div className="mb-4">
