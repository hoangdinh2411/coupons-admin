...
export const Roundedsolidalerts: alert1[] = [
	...
	{ id: 6, text: "A simple solid rounded info alert—check it out! ", class: "solid-info" },
	{ id: 7, text: "A simple solid rounded success alert—check it out!", class: "solid-success" }
];
...
export const Roundedoutlinealerts: alert1[] = [
	...
	{ id: 6, text: "A simple outline rounded warning alert—check it out! ", class: "outline-info" },
	{ id: 7, text: "A simple outline rounded danger alert—check it out!", class: "outline-success" }
];
...
export const Roundedefaultalerts: alert1[] = [
	...
	{ id: 6, text: "A simple rounded warning alert—check it out! ", class: "success" },
	{ id: 7, text: "A simple rounded danger alert—check it out!", class: "info" }
];

export const Roundewithbtnalerts: alert1[] = [
	{ id: 1, text: "A simple rounded primary alert—check it out! ", class: "primary" },
	{ id: 2, text: "A simple rounded secondary alert—check it out! ", class: "secondary" },
	{ id: 3, text: "A simple rounded success alert—check it out! ", class: "success" },
	{ id: 4, text: "A simple rounded info alert—check it out!", class: "info" }
];
...
export const Customizedalert1: alert6[] = [
	...
	{ id: 3, class1: "M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z", color: "success", },
	{ id: 4, class1: "M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27L15.73 3zM12 17.3c-.72 0-1.3-.58-1.3-1.3 0-.72.58-1.3 1.3-1.3.72 0 1.3.58 1.3 1.3 0 .72-.58 1.3-1.3 1.3zm1-4.3h-2V7h2v6z", color: "info", },
];
...
export const Imagealerts: alert7[] = [
	...
	{ id: 3, src1: "../../assets/images/faces/8.jpg", color: "success", class: "" },
...
export const avatarsizealert: alert8[] = [
	{ id: 1, src1: "../../assets/images/faces/3.jpg", color: "primary", class: "xs", class1: "", width:20, height:20},
	{ id: 2, src1: "../../assets/images/faces/5.jpg", color: "secondary", class: "sm", class1: "", width:28, height:28},
	{ id: 3, src1: "../../assets/images/faces/8.jpg", color: "warning", class: "md", class1: "", width:40, height:40},
	{ id: 4, src1: "../../assets/images/faces/11.jpg", color: "danger", class: "lg", class1: "", width:48, height:48},
	{ id: 5, src1: "../../assets/images/faces/13.jpg", color: "info", class: "xl", class1: "", width:64, height:64},
	{ id: 6, src1: "../../assets/images/faces/14.jpg", color: "dark", class: "xxl", class1: "text-muted", width:80, height:80},
];
...
export const Svgalert = [
	{ id: 1, class1: Asvg, text1: "Information Alert", text2: "Information alert to show to information", color: "primary", btn1: "cancel", btn2: "open", class: "primary" },
	{ id: 2, class1: Asvg1, text1: "Success Alert", text2: "Success alert to show to success message", color: "success", btn1: "cancel", btn2: "open", class: "success" },
	{ id: 3, class1: Asvg2, text1: "Warning Alert", text2: "Warning alert to show warning message", color: "warning", btn1: "cancel", btn2: "open", class: "warning" },
	{ id: 4, class1: Asvg3, text1: "Danger Alert", text2: "Danger alert to show the danger message", color: "danger", btn1: "cancel", btn2: "open", class: "danger" },
];
