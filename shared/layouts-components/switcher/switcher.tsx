            ...
            <TabContent className="tab-content" id="nav-tabContent">
                    ...
                    <div className="d-flex flex-wrap align-items-center switcher-style">
                      <Form.Check className="form-check switch-select me-3">
                        <Form.Check.Input
                          ...
                          name="theme-primary"
                          id="switcher-primary"
                          checked={variable.colorPrimaryRgb === '171, 125, 241'}
                          onClick={() => setPrimaryColor('171, 125, 241')}
                        />
                      </Form.Check>
                      <Form.Check className="form-check switch-select me-3">
                        <Form.Check.Input
                          ...
                          checked={variable.colorPrimaryRgb === '69, 184, 224'}
                          onClick={() => setPrimaryColor('69, 184, 224')}
                        />
                      </Form.Check>
                      <Form.Check className="form-check switch-select me-3">
                        <Form.Check.Input
                          ...
                          checked={variable.colorPrimaryRgb === '231, 105, 182'}
                          onClick={() => setPrimaryColor('231, 105, 182')}
                        />
                      </Form.Check>
                      <Form.Check className="form-check switch-select me-3">
                        <Form.Check.Input
                          ...
                          checked={variable.colorPrimaryRgb === '26, 139, 114'}
                          onClick={() => setPrimaryColor('26, 139, 114')}
                        />
                      </Form.Check>
                      <Form.Check className="form-check switch-select me-3">
                        <Form.Check.Input
                          ...
                          checked={variable.colorPrimaryRgb === '10, 106, 169'}
                          onClick={() => setPrimaryColor('10, 106, 169')}
                        />
                      </Form.Check>
              ...
              <div className="d-flex justify-content-between canvas-footer flex-nowrap gap-2">
                <Link
                  ...
                  id="reset-all"
                  className="btn btn-danger text-nowrap w-100"
                  onClick={Reset}
                >
                  Reset
                </Link>
