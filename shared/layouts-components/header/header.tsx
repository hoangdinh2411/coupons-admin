...
import { Col, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Form, ListGroup, Modal, Row} from 'react-bootstrap'
...
const Header = () => {
    ...
    //Cart function
    const cartProduct = [
        { id: 1, image: "/assets/images/media/media-92.jpg", name: "EliteChair Pro", category: "Furniture", qty: ' 01', price: '1299.00' },
        { id: 2, image: "/assets/images/media/media-95.jpg", name: "Sunglasses", category: "Accessories", qty: '01', price: '249.99' },
        { id: 3, image: "/assets/images/media/media-93.jpg", name: "StellarPhone X", category: "Smartphones", qty: '01', price: '1199.08' },
        { id: 4, image: "/assets/images/media/media-96.jpg", name: "PowerBeats Pro", category: "Audio Accessories", qty: '01', price: '249.95' },
    ];
    ...
    const notificationNotes = [
        { id: 1, image: "/assets/images/faces/1.jpg", name: "Sonia Agarwal", notificationType: "Approval", description: "for the Insurance", time: "7 mins ago", status: "text-success", textcolor: "success" },
        { id: 2, image: "/assets/images/faces/12.jpg", name: "Rajesh Kumar", notificationType: "Urgent Request", description: "for project", time: "3 hours ago", status: "text-warning", textcolor: "warning" },
        { id: 3, image: "/assets/images/faces/3.jpg", name: "Ayesha Malik", notificationType: "Task Completed", description: "for redesign", time: "2 hours ago", status: "text-info", textcolor: "info" },
        { id: 4, image: "/assets/images/faces/14.jpg", name: "Mohan Desai", notificationType: "New Message", description: "about client meeting", time: "15 mins ago", status: "text-danger", textcolor: "danger" },
        { id: 5, image: "/assets/images/faces/5.jpg", name: "Priya Sharma", notificationType: "Meeting Reminder", description: "scheduled for 3:00 PM", time: "30 mins ago", status: "text-warning", textcolor: "warning" }
    ]
    ...
    const appData = [
        { name: "Figma", image: "figma.png", bgColorClass: "pink", borderColorClass: "pink" },
        { name: "PowerPoint", image: "microsoft-powerpoint.png", bgColorClass: "success", borderColorClass: "success" },
        { name: "MS Word", image: "microsoft-word.png", bgColorClass: "primary", borderColorClass: "primary" },
        { name: "Calendar", image: "calender.png", bgColorClass: "info", borderColorClass: "info" },
        { name: "Sketch", image: "sketch.png", bgColorClass: "secondary", borderColorClass: "secondary" },
        { name: "Google", image: "google.png", bgColorClass: "danger", borderColorClass: "danger" },
    ];
                ...
                <div className="main-header-container container-fluid">
                    ...
                    <div className="header-content-left">
                        ...
                        <div className="header-element mx-lg-0 mx-2">
                            <Link scroll={false} aria-label="Hide Sidebar" className="sidemenu-toggle header-link animated-arrow hor-toggle horizontal-navtoggle" data-bs-toggle="sidebar" href="#!" onClick={toggleSidebar}><span></span></Link>
                        </div>
                        ...
                        <div ref={containerRef} className="header-element header-search d-lg-block d-none my-auto auto-complete-search">
                            {/* <!-- Start::header-link --> */}

                            <input type="text" className="header-search-bar form-control rounded-pill" onClick={() => { }} ref={searchRef} defaultValue={InputValue} onChange={(ele => { myfunction(ele.target.value); setInputValue(ele.target.value); })} id="header-search" placeholder="Search for Results..." spellCheck={false} autoComplete="off" autoCapitalize="off" />
                            ...
                            {showa ?
                                <div className="card search-result position-absolute z-index-9 search-fix  border mt-1" ref={searchResultRef}>
                    ...
                    <div className="header-content-right">
                        ...
                        <div className="header-element d-lg-none d-flex" >
                            <Link scroll={false} href="#!" className="header-link" onClick={handleShow1} data-bs-toggle="modal" data-bs-target="#responsive-searchModal">
                        ...
                        <Dropdown className="header-element country-selector">
                            ...
                            <DropdownToggle variant='' className="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                                <span className="avatar avatar-xs avatar-rounded">
                                    <Image width={20} height={20} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/flags/us_flag.jpg`} alt="img" />
                                </span>
                            </DropdownToggle>
                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu" data-popper-placement="none" align="end">
                                <li>
                                    <Link scroll={false} className="dropdown-item d-flex align-items-center justify-content-between"
                                        href="#!">
                                ...
                                <li>
                                    <Link scroll={false} className="dropdown-item d-flex align-items-center justify-content-between"
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                <Image width={20} height={20} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/flags/spain_flag.jpg`} alt="img" />
                                            </span>
                                            Spanish
                                        </div>
                                    </Link>
                                ...
                                <li>
                                    <Link scroll={false} className="dropdown-item d-flex align-items-center justify-content-between"
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                <Image width={20} height={20} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/flags/french_flag.jpg`} alt="img" />
                                            </span>
                                            French
                                        </div>
                                    </Link>
                                ...
                                <li>
                                    <Link scroll={false} className="dropdown-item d-flex align-items-center justify-content-between"
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                <Image width={20} height={20} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/flags/uae_flag.jpg`} alt="img" />
                                            </span>
                                            German
                                        </div>
                                    </Link>
                                ...
                                <li>
                                    <Link scroll={false} className="dropdown-item d-flex align-items-center justify-content-between"
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                <Image width={20} height={20} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/flags/italy_flag.jpg`} alt="img" />
                                            </span>
                                            Italian
                                        </div>
                                    </Link>
                                ...
                                <li>
                                    <Link scroll={false} className="dropdown-item d-flex align-items-center justify-content-between"
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                <Image width={20} height={20} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/flags/russia_flag.jpg`} alt="img" />
                                            </span>
                                            Russian
                                        </div>
                                    </Link>
                        ...
                        <li className="header-element header-theme-mode">
                            ...
                            <Link scroll={false} href="#!" className="header-link layout-setting" onClick={toggleTheme} >
                                <span className="light-layout">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><rect fill="none" height="24" width="24" /><path d="M9.37,5.51C9.19,6.15,9.1,6.82,9.1,7.5c0,4.08,3.32,7.4,7.4,7.4c0.68,0,1.35-0.09,1.99-0.27C17.45,17.19,14.93,19,12,19 c-3.86,0-7-3.14-7-7C5,9.07,6.81,6.55,9.37,5.51z M12,3c-4.97,0-9,4.03-9,9s4.03,9,9,9s9-4.03,9-9c0-0.46-0.04-0.92-0.1-1.36 c-0.98,1.37-2.58,2.26-4.4,2.26c-2.98,0-5.4-2.42-5.4-5.4c0-1.81,0.89-3.42,2.26-4.4C12.92,3.04,12.46,3,12,3L12,3z" /></svg>
                        ...
                        <Dropdown className="header-element cart-dropdown" align={"end"} autoClose="outside">
                            ...
                            <DropdownToggle href="#!" className="header-link" variant='' as='a'>
                                ...
                                <SpkBadge variant='primary' Customclass="rounded-pill header-icon-badge" Id="cart-icon-badge">
                                    {card.length}
                                </SpkBadge>
                            </DropdownToggle>
                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                <div className="p-3 bg-light bg-opacity-75">
                                    <div className="d-flex align-items-center justify-content-between">
                                        <p className="mb-0 fw-semibold">Cart Items</p>
                                        <SpkBadge variant="pink" Customclass="ms-1 fs-12" Id="cart-data">  {card.length} Items</SpkBadge>
                                    </div>
                                </div>
                                            ...
                                            <div className="d-flex align-items-center gap-3">
                                                <div className="lh-1">
                                                    <span className="avatar avatar-lg bg-light">
                                                        <Image width={48} height={48} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}${item.image}`} alt="img" />
                                                    </span>
                                                </div>
                                                <div className="flex-fill">
                                                    ...
                                                    <div className="fs-11 fw-medium text-default"><span className="text-muted">Qty:</span> {item.qty}</div>
                                                </div>
                                                <div className="text-end">
                                                    <Link scroll={false} href="#!" className="header-cart-remove float-end dropdown-item-close" onClick={(event) => handleDelete(item.id, event)} ><i className="ti ti-trash"></i></Link >
                        ...
                        <Dropdown className="header-element notifications-dropdown d-xl-inline-flex dropdown" align={"end"} autoClose="outside">
                            ...
                            <DropdownToggle href="#!" variant='' className="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="messageDropdown" aria-expanded="false">
                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu-end" data-popper-placement="none">
                                <div className="p-3 bg-light bg-opacity-75">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <span className="badge bg-pink" id="notifiation-data">{note.length} Unread</span>
                                    </div>
                                </div>
                                <div className="dropdown-divider"></div>
                                            ...
                                            <div className="d-flex align-items-start">
                                                ...
                                                <div className="flex-grow-1 d-flex align-items-center justify-content-between">
                                                    <div>
                                                        ...
                                                        <span className="text-muted header-notification-text fs-11">{item.time}</span>
                                                    </div>
                                                    <div>
                                                        <Link scroll={false} href="#!" className="text-muted me-1 dropdown-item-close1" onClick={(e) => handleNoteRemove(item.id, e)} >
                        ...
                        <Dropdown className="header-element header-shortcuts-dropdown" align={"end"}>
                            ...
                            <DropdownToggle variant='' className="header-link" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="notificationDropdown" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><g><rect fill="none" height="24" width="24" /></g><g><g><g><path d="M3,3v8h8V3H3z M9,9H5V5h4V9z M3,13v8h8v-8H3z M9,19H5v-4h4V19z M13,3v8h8V3H13z M19,9h-4V5h4V9z M13,13v8h8v-8H13z M19,19h-4v-4h4V19z" /></g></g></g></svg>
                            </DropdownToggle>
                            ...
                            <DropdownMenu className="main-header-dropdown header-shortcuts-dropdown dropdown-menu pb-0 dropdown-menu-end" aria-labelledby="notificationDropdown">
                                <div className="p-3 bg-light bg-opacity-75">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        {appData.map((app, index) => (
                                            <Col className="col-4" key={index}>
                                                <Link scroll={false} href="#!" className="related-apps">
                                                    <div className={`text-center p-3 related-app ${app.bgColorClass} bg-${app.bgColorClass}-transparent border border-${app.borderColorClass} border-opacity-10`} >
                                                        <span className={`avatar avatar-md avatar-rounded bg-${app.bgColorClass} bg-opacity-10 border border-${app.borderColorClass} border-opacity-10 p-2 mb-2`} >
                                                            <Image fill src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/apps/${app.image}`} alt={app.name} />
                                                        </span>
                        ...
                        <div className="header-element header-fullscreen">
                            ...
                            <Link href="#!" className="header-link" onClick={toggleFullscreen}>
                                {isFullscreen ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="full-screen-close header-link-icon" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" /></svg>
                                ) : (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="full-screen-open header-link-icon" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"></path></svg>
                                )}
                            </Link>
                        ...
                        <Dropdown className="header-element dropdown" align={"end"}>
                            ...
                            <DropdownToggle variant='' className="header-link" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <span className="avatar avatar-sm avatar-rounded">
                                    <Image height={28} width={28} src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/images/faces/14.jpg`} alt="img" className="img-fluid" />
                                </span>
                            </DropdownToggle>

                            {/* <!-- End::header-link|dropdown-toggle --> */}

                            <DropdownMenu className="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                        ...
                        <li className="header-element">
                            ...
                            <Link href="#!" scroll={false} className="header-link switcher-icon" data-bs-toggle="offcanvas" onClick={handleShow} data-bs-target="#switcher-canvas">
