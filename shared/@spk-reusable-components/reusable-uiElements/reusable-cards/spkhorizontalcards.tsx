                ...
                <div className="row g-0">
                    {Imgposition === "before" ?
                        <div className="col-md-4">
                            <Image fill src={Imagesrc as string} className={Imgclass} alt="..." />
                        </div>
                        : ''}
                    ...
                    {Imgposition === "after" ?
                        <div className="col-md-4">
                            <Image fill src={Imagesrc as string} className="img-fluid rounded-sm-end rounded-bottom h-100 w-100" alt="..." />
                        </div>
                        : ''}
                </div>
            </Card>
